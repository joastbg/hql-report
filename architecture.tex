...
\texttt{Thirty360} assumes that all months have 30 days, and that each year has
...
financial markets and are typically only offered by governments or large 
...
we have created an \texttt{Amortized} class:
...
different for this bond type, as we see in figure \ref{fig:annuitycf}.
...
In addition to the zero and amortized bonds, \hql also features various other
