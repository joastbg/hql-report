...
was generated. The converse is not true, we cannot use a serial's rate to
discount a bullet.\\
...
\ref{fig:anc} with an offset of 3.5 years would produce $2.4\%$. We have
...
is a forward rate. This is conceptual leap required to understand these,
as they are simply interest rates in the future. Notwithstanding, their
usefulness is may not be evident. As mentioned, floating-rate bonds are
defined by the fact that the interest rate is non-deterministic. 
