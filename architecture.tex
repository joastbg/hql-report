...
\draw[->] (origo) -- (yaxis) node[above] {Interest rate\footnote{Recall that \hql assumes annual rates.}};
...
\ab{Do we need to import \texttt{Data.List}?}
...
%%% Explain bond instances of Instrument %%%
    % Discuss lists/backend representation

% TODO Write that very few methods belong in the Instrument class,
% just like in Quantlib!
