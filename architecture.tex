...
unctionality that all financial instruments must share:
...
of a serial (the person who initially loaned the money) receives repayments over
...
\begin{hscode}
class Amortized a where
  TODO
\end{hscode}

\texttt{repayments} now generate the blue repayment part of the cashflow
