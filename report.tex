...
Johan Astborg has produced the documentation for our software, and Andreas Bock
has written this report. Please refer to appendix \ref{chap:contrib} for an 
overview of contributions to the software.
\end{abstract}
%-----------------------------------------------------------
\tableofcontents
%-----------------------------------------------------------
